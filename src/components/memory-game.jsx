...
const MemoryGame = () => {
  ...
  const handleClick = (id) => {
    ...
    if (flipped.includes(id)) return; // prevent same card double click
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 p-4">
      ...
      {/* Result */}
      {won && (
        <div className="text-2xl font-bold text-green-600 mb-4">You Won!</div>
      )}
